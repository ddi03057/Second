...
var _Delfino_Servlet = window.location.origin + "/jsp"; //servlet base
...
var DelfinoConfig = {
    ...
    nonceUrlServlet : _Delfino_Servlet + "/delfinoNonce",
    nonce : null ,
    ...
    serverTimeUrlServlet : _Delfino_Servlet + "/delfinoServerTime",
...
var g4Keypad = {
    ...
    toggleByButton: false, // 버튼으로 토글하기. 웹접근성.
};
...
// true 일 경우 태블릿에서도 모바일모드UI 사용.
// DelfinoConfig.g4.forceMobile = true;
...
DelfinoConfig.cg.VPCGClientConfig = {
    ...
    multiSignProviders: 'delfino,kakaotalk,toss,naver2,fincert,fincertcorp',
	
	// mdSign 사용시 표시할 provider 목록, 설정하지 않으면 displayProviders목록 그대로 사용
    mdSignProviders: 'delfino,toss,fincert,fincertcorp',
