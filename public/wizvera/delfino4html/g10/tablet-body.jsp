            ...
            <div class="passwordBlock">
                <div class="passwordBorder">
                    ...
                    <div class="passwordBlockInner createEasyPasswordCancelInput">
                        <label class="certPassword">인증서 비밀번호</label><input class="passwordInput easyPasswordDialogInput" name="kbtamPasswordInput" aria-label="인증서 암호" alt="인증서 암호" name="easyPasswordDialogInput" type="password" autocomplete="off" disabled/><button class="keyboardButton" style="display: none"></button>
                    </div>
                    <div class="certpinContainer" style="display: none;">
