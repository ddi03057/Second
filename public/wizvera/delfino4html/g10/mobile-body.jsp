        ...
        <fieldset id="providers-section" class="rightContent">
            <div id="vpcg_content" class="content">
                ...
                <div class="vpcg_section_wait m_vpcg_info_screen_normal">
                    ...
                    <div class="m_vpcg_info_bottom_text vpcgInfoFirst">선택한 인증수단의 <span class="fs-13 color-06 fw-b">모바일앱 알람</span>을 확인해주세요.</div>
                </div>
				<div class="vpcg_section_wait_btn m_vpcg_info_screen_normal with_button">
                    ...
                    <div class="m_vpcg_info_top_text">인증요청이 휴대폰으로 전송되었습니다.</div>
                    <div class="m_vpcg_info_bottom_text vpcgInfoSecond">선택한 인증수단의 <span class="fs-13 color-06 fw-b">모바일앱에서 인증을 완료</span>한 후,<br/>아래의 <span class="fs-13 color-06 fw-b"><u>확인버튼</u></span>을 눌러주세요.</div>
