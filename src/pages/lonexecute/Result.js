                    ...
                    <div className="content">
                        <div className="content-body">
                            <div className="content-top line-be4">
                                <p className="top-tit">대출 금액 <span className="fw-b"><em className="fc-default">30,000,000</em>원</span>이 <br /> <strong>입금</strong>되었습니다.</p>
                            ...
                            <section className="section line-tf4">
                                <div className="info-wrap">
                                    ...
                                    <div className="info-box">
                                        ...
                                        <p className="txt fc-dark ta-r">0.00%<span className="dp-b fs14 fc-lightGray ta-r">(기준금리 0.00% <br />+ 가산금리 0.00%)</span></p>
                                    </div>
                                    <div className="info-box">
                                    ...
                                    <div className="info-box ai-c">
                                        ...
                                        <span className="txt fc-dark ta-r">123-456452-00045</span>
                                    </div>
                                    <div className="info-box">
                                    ...
                                    <div className="info-box">
                                        ...
                                        <span className="txt fc-dark ta-r">운전자금</span>
                                    </div>
                                    <div className="info-box">
                                        <span className="tit fc-gray">상환방법</span>
                                        <span className="txt fc-dark ta-r">원금균등분할상환</span>
                                    </div>
                                    <div className="info-box ai-c">
